...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8076947624:AAE6HPit4NQUnYaLCdIJnsR8w4hobIYrk4I")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002053656211"))
...
FORCE_CHANNEL = int(os.environ.get("FORCE_CHANNEL", "-1002021511547"))
FORCE_CHANNEL2 = int(os.environ.get("FORCE_CHANNEL2", "-1001974625912"))
REQUEST_CHANNEL = int(os.environ.get("REQUEST_CHANNEL", "-1002437501106"))
