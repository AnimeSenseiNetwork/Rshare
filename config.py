...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6982088057:AAFpNrx-UybemuRKa43qdEuQAArdPrm7UXo")
...
REQUEST_CHANNEL = int(os.environ.get("REQUEST_CHANNEL", "-1002430814987"))
