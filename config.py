...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6501228626:AAE-c5mYgotEjynXOK_RAiQo0dvurcoIp3s")
...
FORCE_CHANNEL = int(os.environ.get("FORCE_CHANNEL", "-1001912002678"))
FORCE_CHANNEL2 = int(os.environ.get("FORCE_CHANNEL2", "-1002122135414"))
REQUEST_CHANNEL = int(os.environ.get("REQUEST_CHANNEL", "-1002266498528"))
