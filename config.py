...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6501228626:AAG6EfFrt9X1JQYIPf09NeVTrssoH2-jfvE")
...
FORCE_CHANNEL = int(os.environ.get("FORCE_CHANNEL", "-1002008735707"))
FORCE_CHANNEL2 = int(os.environ.get("FORCE_CHANNEL2", "-1001717121807"))
REQUEST_CHANNEL = int(os.environ.get("REQUEST_CHANNEL", "-1002838207204"))
