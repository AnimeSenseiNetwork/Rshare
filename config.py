...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6813308007:AAGOdFChJJsPw4LtxRC--cOzY3v235zaaCM")
...
FORCE_CHANNEL2 = int(os.environ.get("FORCE_CHANNEL2", "-1001760428426"))
REQUEST_CHANNEL = int(os.environ.get("REQUEST_CHANNEL", "-1001133546052"))
...
#Force sub message 
FORCE_MSG = os.environ.get("FORCE_SUB_MESSAGE", "😐sᴏʀʀʏ ! ʏᴏᴜ ʜᴀᴠᴇɴ'ᴛ ᴊᴏɪɴᴇᴅ ᴄʜᴀɴɴᴇʟ ᴘʟᴇᴀsᴇ😋 ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ ᴛʜᴇɴ ᴛʀʏ ᴀɢᴀɪɴ. Note : ᴍᴜsᴛ ᴊᴏɪɴ **https://t.me/+Rh_eKVXt0tJkOWY1** ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ғɪʟᴇs")
